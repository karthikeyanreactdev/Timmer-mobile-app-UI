    ...
    render() {
        return (
            ...
            >
                ...
                <Tab.Screen name="signout" component={MachineTimer}  />
...

{
    ...
    //   });
//await AsyncStorage.clear()
  props.navigation.navigate('App2', {screen: 'Auth'})
...
function MachineScreen({ navigation }) {
    ...
    return (
        ...
        <NavigationContainer  >
            ...
            <Drawer.Navigator initialRouteName="Home" drawerContent={props => <CustomDrawerContent {...props} />}>
               ...
               <Drawer.Screen name="Reports" component={LogoutScreen} options={{ headerShown: true, headerTitle: '' }} />
                {/*  <Drawer.Screen name="Timer" component={MachineTimer} options={{ headerShown: true, headerTitle: '' }} />
                <Drawer.Screen name="Lo" component={LogoutScreen} options={{ headerShown: true, headerTitle: '' }}/>  */}
...
export default withNavigation(MachineScreen)